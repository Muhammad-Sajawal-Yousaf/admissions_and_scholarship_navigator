  ...
  <footer className="mx-auto max-w-screen-2xl px-4 md:px-8">
    <div className="flex flex-col items-center border-t pt-6">
      ...
      <nav className="mb-4 flex flex-wrap justify-center gap-x-4 gap-y-2 md:justify-start md:gap-6">
        ...
        <a href="/ContactUs" className="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600">Contact Us</a>
      ...
      <div className="flex gap-4">
        ...
        <a href="#" target="_blank" className="text-gray-400 transition duration-100 hover:text-blue-500 active:text-gray-600">
          <svg className="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="py-1 text-center text-sm text-gray-400">© 2021 - Present SajawalSolutions. All rights reserved.</div>
  </footer>
</div>
   </>
  )
